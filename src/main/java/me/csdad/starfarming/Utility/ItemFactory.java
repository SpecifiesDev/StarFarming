...
public class ItemFactory {
	...
	// store an itemstack to manipulate for this factory
	private ItemStack stack;
	
	// retrieve an instance of our main class
	private Core plugin;
	...
	// add an overridable constructor to allow for a reconstruction of an existing item
