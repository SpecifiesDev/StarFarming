...
public enum PerkDescriptions {
    ...
    TIER1_HEIRLOOM("&4&lHeirloom Oriented~&7Players have a chance to receive more seeds from harvesting grass, scaling with &2Farming Level&7."),
    ...
    TIER3_WINTER_SOLDIER("&b&lWinter Soldier~&7You may now plant crops that normally are unable to grow inside of winter. Remove &lmost &7planting restrictions.~&8Crops that meet this criteria grow &3&l507% &8faster and give more &3experience&7."),
